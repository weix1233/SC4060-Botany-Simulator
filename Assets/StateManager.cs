...
public class StateManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(sunlightState==state.HEALTHY) sun.GetComponent<Image>().material = healthy;
        else sun.GetComponent<Image>().material = unhealthy;
        if(waterState==state.HEALTHY) water.GetComponent<Image>().material = healthy;
        else water.GetComponent<Image>().material = unhealthy;
        if(fertiliserAState==state.HEALTHY) fertA.GetComponent<Image>().material = healthy;
        else fertA.GetComponent<Image>().material = unhealthy;
        if(fertiliserBState==state.HEALTHY) fertB.GetComponent<Image>().material = healthy;
        else fertB.GetComponent<Image>().material = unhealthy;
